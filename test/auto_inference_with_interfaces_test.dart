...
void main() {
  ...
  test('✅ Teste: AppModule fornece dependências para outro módulo', () async {
    ...
    // ✅ IMPORTANTE: O AppModule deve estar acessível via getContextualInjector
    // Vamos verificar que o AppModule está no contexto principal
    ...
    // ✅ O getContextualInjector deve retornar o injector do módulo atual
    // que deve ter acesso ao injector principal (AppModule) via addInjector
    // Então AppService do AppModule deve estar acessível
