# Disciplina de Imports Internos

## Purpose

Define a disciplina de dependências internas do pacote: arquivos sob `lib/src/` dependem explicitamente dos arquivos específicos que usam, nunca do barril público, e o subsistema de DI mantém dependências mínimas. Inclui a guarda automatizada que previne a regressão do import de barril.
