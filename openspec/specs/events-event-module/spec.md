...
Define o EventModule como um Module concreto com suporte a eventos: a incorporação direta da lógica de escuta, o disparo dos hooks de escuta em initState, o descarte de assinaturas e a composição de módulos via listen.
