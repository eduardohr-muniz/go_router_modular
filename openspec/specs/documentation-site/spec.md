...
Define o comportamento normativo do site de documentação do pacote: a stack (Nextra 4 sobre Next.js App Router), a internacionalização com prefixo de locale (EN/PT), a paridade de conteúdo e navegação entre idiomas, a exatidão técnica alinhada à API pública e às specs, e o build estático compatível com GitHub Pages.
