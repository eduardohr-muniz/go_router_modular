# Ciclo de Vida no Roteamento

## Purpose

Define a ligação entre navegação e ciclo de vida do DI: registro de binds no redirect ao entrar na rota, descarte ao sair via ParentWidgetObserver, proteção contra descarte prematuro em transição, descarte em cascata de branches e o ModularLoader durante o registro.
