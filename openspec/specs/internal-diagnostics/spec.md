...
Define os mecanismos internos de diagnóstico do pacote: asserções que orientam o desenvolvedor (por exemplo, quando configure não foi chamado) e o log interno controlado por flag de compilação.
